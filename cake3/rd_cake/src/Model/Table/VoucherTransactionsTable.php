 ...
 * @property \App\Model\Table\PartnerUsersTable&\Cake\ORM\Association\BelongsTo $PartnerUsers
...
//        ]);
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmptyString('transfer_amount');
...
//        $rules->add($rules->existsIn(['partner_user_id'], 'PartnerUsers'));
